...
class Question extends Model
{
    ...
    public function open(): void {
        if (!$this->sitting()->isOpen()) throw new Exception("tried to open question when sitting was not open");
        if ($this->isOpen() || $this->isClosed()) throw new Exception("tried to open question when it has already been opened");
        $this->opened_at=now();
    }
