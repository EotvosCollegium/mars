...
return [
    ...
    'access_token' => [
        'create' => 'Create',
        'created' => "Access token created successfully",
        'created_description' => 'Copy the token below and store it securely, as it will not be shown again.',
    ...
    'country' => 'Country',
    'county' => 'County',
    'data_cannot_be_edited_application' => 'To edit your information, contact the [system administrators](mailto::SYSADMIN_EMAIL).',
    ...
    'some_data_cannot_be_edited' => 'You cannot edit some of your information. You should contact the [system administrators](mailto::SYSADMIN_EMAIL) to edit them.',
    ...
    'transit_time_tooltip' => 'The time needed to get into the college from the above address with public transport (according to Google Maps, calculating with a Sunday evening).',
