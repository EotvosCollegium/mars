...
return [
    ...
    'wifi_password_info' => 'You can connect to ejcwifi_radius with the credentials listed below. You can change your password to a randomly generated one.<br>After obtaining access from an admin, it might take ca. 10 minutes until the system lets you in.<br>If your device asks for more information to connect to the network, you can try these:<br>1. EAP method: PEAP<br>2. Phase 2 authentication: MSCHAPv2<br>3. CA certificate: Use system certificate<br>4. Domain: <code>wifi.eotvos.elte.hu</code><br>5. Username: wifi username (see below)<br>6. Anonymous identity: same username<br>7. Password: wifi password (see below)<br>On Windows, it might fail at first. In that case, forget the network, then follow <a href="https://www3.uwsp.edu/infotech/Pages/Tutorials/Wireless/Windows-10-Wireless-Setup.aspx" target="_blank">these instructions</a>.<br>If the problem persists, <a href="mailto:root@eotvos.elte.hu">ask the admins for help</a>.',
