...
return [
    ...
    'cost' => 'Cost',
    'costs' => 'HUF :two_sided / sheet, (odd number of pages: last sheet: HUF :one_sided)',
    ...
    'modify' => 'Modify',
    'no-paper-description' => 'If the printer has run out of paper or the printer has jammed, you can notify the system administrators here. If you have other concerns, contact the system administrators via <a href="mailto:' . config('contacts.mail_sysadmin') . '">their e-mail address</a>.',
