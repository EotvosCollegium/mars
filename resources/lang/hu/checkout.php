...
return [
    ...
    'paid' => 'A tartozás ki lett fizetve',
    'pay' => 'Fizetés',
    'pay_depts_descr' => 'Szedd be / fizesd ki az alábbi összegeket. Ezzel a tranzakciók még nem kerülnek a kasszába, de törleszted a tartozásokat.<br>Pozitív összeg esetén a személy tartozik, negatív esetén a kassza.',
    ...
    'sum' => 'Összesen',
    'to_checkout' => 'Tedd be (ha negatív) / vedd ki (ha pozitív) ezt az összeget a kasszából',
    'transaction_created' => 'Tranzakció létrehozva',
    'transaction_deleted' => 'Transakció törölve',
    'transaction_for_workshop' => 'Fizetés műhelynek',
    'transaction_updated' => 'Tranzakció frissítve',
    'transactions' => 'Tranzakciók',
    'transactions_has_been_deleted' => 'A tranzakciók törlésre kerültek a rendszerből.',
