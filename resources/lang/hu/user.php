...
return [
    ...
    'access_token' => [
        'create' => 'Létrehozás',
        'created' => "Hozzáférési token sikeresen létrehozva",
        'created_at' => 'Létrehozva',
        'created_description' => 'Másold ki az alábbi tokent, és mentsd el biztonságosan, mert később nem lesz újra megjelenítve.',
        'revoke' => 'Visszavonás',
    ...
    'calculated_automatically' => 'automatikusan számolva',
    'city' => 'Város',
    'contact' => 'Elérhetőség',
    'country' => 'Ország',
    'county' => 'Megye',
    'data_cannot_be_edited_application' => 'A felvételi folyamat miatt Önnek jelenleg nincs lehetősége adatait módosítani. Amennyiben módosítani kíván adatain, keresse a [rendszergazdákat](mailto::SYSADMIN_EMAIL), a [Választmányt](mailto::STUDENT_COUNCIL_EMAIL), illetve a [Titkárságot](mailto::SECRETARIAT_EMAIL).',
    ...
    'transit_time' => 'Ingázási idő',
    'transit_time_tooltip' => 'Az az idő, amennyi alatt a fenti lakcímről be lehet jutni a Collegiumba tömegközlekedéssel (a Google Maps szerint, egy vasárnap estével számolva).',
