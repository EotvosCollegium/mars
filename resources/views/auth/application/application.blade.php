...
<div class="card">
    <div class="card-content">
		...
		@endif
                        ...
                        <tr>
                            ...
                            <td>
                                {{ $user->educationalInformation->high_school }}<br>
                                 @if(!$user->educationalInformation->high_school)<span style="font-style:italic;color:red">hiányzó adat</span> @endif 
                            </td>
                        </tr>
                        <tr>
			...
			@else
			<tr><th>Tanulmányi adatok</th><td><span style="font-style:italic;color:red">hiányzó adatok</span></td></tr>
			@endif
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if(!$user->educationalInformation || !$user->educationalInformation->year_of_graduation) <span style="font-style:italic;color:red">hiányzó adat</span> @endif
                            </td>
                        </tr>
                        <tr>
