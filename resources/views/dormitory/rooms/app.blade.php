            ...
            <div class="card-content">
                ...
                <svg
                    ...
                    <g
                        ...
                        id="room235" 
                        data-info="{{ $users->where('room', 235)->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        data-info="{{ $users->where('room', 234)->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room233"
                        data-info="{{ $users->where('room', 233)->pluck('name')->join(';') }}" />
                        <path
                        ...
                        id="room232"
                        sodipodi:nodetypes="ccccc"
                        data-info="{{ $users->where('room', 232)->pluck('name')->join(';') }}" />
                        <path
                        ...
                        id="room231"
                        sodipodi:nodetypes="ccccc"
                        data-info="{{ $users->where('room', 231)->pluck('name')->join(';') }}" />
                        <path
                        ...
                        id="room230"
                        data-info="{{ $users->where('room', 230)->pluck('name')->join(';') }}" />
                        <path
                        ...
                        id="room229"
                        data-info="{{ $users->where('room', 229)->pluck('name')->join(';') }}" />
                        <path
                        ...
                        id="room228"
                        sodipodi:nodetypes="ccccc" 
                        data-info="{{ $users->where('room', 228)->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room227"
                        sodipodi:nodetypes="ccccc" 
                        data-info="{{ $users->where('room', 227)->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room226" 
                        data-info="{{ $users->where('room', 226)->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room225" 
                        data-info="{{ $users->where('room', 225)->pluck('name')->join(';') }}"/>
                        <path
                        style="fill:#808080;stroke:#000000;stroke-width:0.264583px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
                        ...
                        id="room224" 
                        data-info="{{ $users->where('room', 224)->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room223" 
                        data-info="{{ $users->where('room', 223)->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room222" 
                        data-info="{{ $users->where('room', 222)->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room221" 
                        data-info="{{ $users->where('room', 221)->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room220" 
                        data-info="{{ $users->where('room', 220)->pluck('name')->join(';') }}"/>
                        <path
                        style="fill:#808080;stroke:#000000;stroke-width:0.264583px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
                        ...
                        id="room218" 
                        data-info="{{ $users->where('room', 218)->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room217" 
                        data-info="{{ $users->where('room', 217)->pluck('name')->join(';') }}"  />
                        <path
                        ...
                        id="room216"
                        data-info="{{ $users->where('room', 216)->pluck('name')->join(';') }}" />
                        <path
                        ...
                        id="room215" 
                        data-info="{{ $users->where('room', 215)->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room214" 
                        data-info="{{ $users->where('room', 214)->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room213" 
                        data-info="{{ $users->where('room', 213)->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room212" 
                        data-info="{{ $users->where('room', 212)->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room211" 
                        data-info="{{ $users->where('room', 211)->pluck('name')->join(';') }}"/>
                        <path
                        style="fill:#808080;stroke:#000000;stroke-width:0.264583px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
                        ...
                        id="room210"
                        sodipodi:nodetypes="ccccc" 
                        data-info="{{ $users->where('room', 210)->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room209"
                        sodipodi:nodetypes="ccccc" 
                        data-info="{{ $users->where('room', 209)->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room208"
                        sodipodi:nodetypes="ccccc" 
                        data-info="{{ $users->where('room', 208)->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room207"
                        data-info="{{ $users->where('room', 207)->pluck('name')->join(';') }}" />
                        <path
                        ...
                        id="room206" 
                        data-info="{{ $users->where('room', 206)->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room205B" 
                        data-info="{{ $users->where('room', '205B')->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room205A" 
                        data-info="{{ $users->where('room', '205A')->pluck('name')->join(';') }}"/>
                        <path
                        ...
                        id="room204" 
                        data-info="{{ $users->where('room', 204)->pluck('name')->join(';') }}"/>
                        <path
                        style="fill:#808080;stroke:#000000;stroke-width:0.264583px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
                        ...
                        <div class="row">
                            ...
                            @for ($i = 1; $i <= $room->capacity; $i++)
                                @if ($users_in_room->count()>=$i)
                                    <x-input.select form="update-all" :s="$width" name="{{$room->name}}[]" id="{{$room->name}}_person_{{$i}}" :elements="$users" :default="$users_in_room[$i-1]" text="rooms.resident{{$i}}"/>
                                @else
                                    <x-input.select form="update-all" :s="$width" name="{{$room->name}}[]" id="{{$room->name}}_person_{{$i}}" :elements="$users" text="rooms.resident{{$i}}"/>
                                @endif
                            @endfor
                        </div>
                    @endforeach
