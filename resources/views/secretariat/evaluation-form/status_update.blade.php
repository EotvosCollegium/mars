<div class="card">
    <div class="card-content">
        ...
        <form action="{{ route('secretariat.evaluation.status-update') }}" method="post">
            @csrf
                @if(user()->isResident())
            ...
            <div class="row">
                ...
                <x-input.text xl=6 id="comment" placeholder="Rövid megjegyzés: BB/Erasmus/két képzés között/stb." maxlength="20"/>
                <x-input.checkbox s=12 id="request" text="Írok kérvényt." />
            </div>
            <div class="row">
