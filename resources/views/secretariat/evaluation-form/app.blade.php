...
<div class="row">
    <div class="col">
        <blockquote>
            ...
            bármilyen helyesbítést, megjegyzést írj be a megfelelő mezőbe. A rendszerben a követelmények teljesítésére kiszámolt adatok csak tájékoztató jellegűek.</p>
            ...
            <p>A kérvényeket a <a href="mailto:{{ config('mail.secretary_email')}}"> titkárság</a> számára küldd el időben.</p>
        ...
        <blockquote class="error">
            Megjegyzés rendszergazdáknak: a határidő állítható a .env fájlban. Ha nem lett frissítve előző szemeszterről, akkor az alapértelmezett értéke a deactivate status signal EventTrigger dátima. Az EventTrigger aktiválásakor alumnivá állítja a rendszer azokat, akik nem töltötték ki a következő félévre a státuszukat, ezért mindenképp győzödj meg róla, hogy ez később történik, mint a form határideje.
        </blockquote>
        @endif
    </div>
</div>
