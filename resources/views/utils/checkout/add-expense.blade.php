    ...
    <div class="card-content">
        ...
        <form method="POST" action="{{ route($route_base . '.expense.add') }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                @can('administrate', $checkout)
                <x-input.select m=6 l=6 id="expense-payer" name="payer" text="Fizető" :elements="\App\Models\User::collegist()->with('educationalInformation')->get()" default="{{user()->id}}" :formatter="function($user) { return $user->uniqueName; }" />
