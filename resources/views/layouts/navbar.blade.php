...
<div class="navbar-fixed">
    <nav class="top-nav">
        <div class="nav-wrapper">
            <div class="row">
                ...
                <a href="#" id="aprilfools" style="transform: scaleX(-1); display: inline-block;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-symmetry-vertical" viewBox="0 0 16 16">
  <path d="M7 2.5a.5.5 0 0 0-.939-.24l-6 11A.5.5 0 0 0 .5 14h6a.5.5 0 0 0 .5-.5zm2.376-.484a.5.5 0 0 1 .563.245l6 11A.5.5 0 0 1 15.5 14h-6a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .376-.484M10 4.46V13h4.658z"/>
                ...
                <script>
                    if(localStorage.getItem("dont_mirror") == "true") {
                        document.body.classList.remove("april_fools");
                    } else {
                        document.body.classList.add("april_fools");
                    }
                    document.getElementById("aprilfools").addEventListener("click", function() {
                        if(localStorage.getItem("dont_mirror") == "true") {
                            localStorage.setItem("dont_mirror", "false");
                            document.body.classList.add("april_fools");
                        } else {
                            localStorage.setItem("dont_mirror", "true");
                            document.body.classList.remove("april_fools");
                        }
                    });
                </script>
