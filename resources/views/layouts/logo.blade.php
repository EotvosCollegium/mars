<ul class="coli blue" style="padding:20px">
    ...
    <div class="row">
        <div class="col s12 valign-wrapper center-align">
            ...
            <div class="white-text noselect" style="padding-top:20px;text-indent:15px;font-size:40px;text-transform: uppercase;font-weight:300;letter-spacing:3px;" > {{ config('app.name') }} </div>
            <sup class="white-text noselect" style="height:15px">{{ config('app.version') }}</sup>
        </div>
    </div>
    </a>
