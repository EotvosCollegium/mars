    ...
    <div class="card-content">
        ...
        <form action="{{ route('internet.report_fault') }}" method="post">
            <div class="form-row align-items-center">
                @csrf
                <div class="row">
                    <x-input.text l=7 id="report" placeholder="doesn't connect" required locale="internet"/>
                    <x-input.text l=3 id="user_os" placeholder="Windows 11" required locale="internet"/>
