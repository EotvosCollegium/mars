...
\title{Igazolás konferencia-előadásról\vspace{-1.0cm}}
\date{}
\author{}
...
Alulírott Horváth László, az ELTE Eötvös Collegium igazgatója hivatalosan igazolom, hogy {{ $name }} (Neptun-kód: {{ $neptun }}) a {{ $date }} megrendezett {{ $conference }} konferencián {{ $title }} címmel előadást tartott.
